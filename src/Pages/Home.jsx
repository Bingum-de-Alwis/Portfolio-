...
const WORDS = ["Full-Stack Developer", "Software Engineering Student"];
const TECH_STACK = ["React", "Node.js", "MongoDB", "TypeScript", "Express.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Bingum-de-Alwis" },
  { icon: Linkedin, link: "https://linkedin.com/in/bingum-de-alwis-99b398252" },
  { icon: Mail, link: "mailto:hpbdealwis@gmail.com" }
];
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[5%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 lg:ml-[3%]"
              data-aos="fade-right"
              data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Aspiring Software Engineering undergraduate with a passion for full-stack development, cloud computing, and artificial intelligence.
                </p>
